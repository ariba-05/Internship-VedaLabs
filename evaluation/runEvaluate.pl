...
# where the binary is
my $evaluateBin = "/media/ariba/Mine/fddb/evaluation/evaluate"; 
# where the images are
my $imDir = "/media/ariba/Mine/fddb/original-pics/"; 
# where the folds are
my $fddbDir = "/media/ariba/Mine/fddb/FDDB-folds"; 
# where the detections are
my $detDir = "/media/ariba/Mine/fddb/output-detection/"; 
###########################
