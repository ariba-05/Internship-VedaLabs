...
#else
  string baseDir = "../original-pics/";
  string listFile = "../FDDB-folds/FDDB-fold-01.txt";
  string detFile = "../output-detection/fold-01-out.txt";
  string annotFile = "../FDDB-folds/FDDB-fold-01-ellipseList.txt";
#endif
